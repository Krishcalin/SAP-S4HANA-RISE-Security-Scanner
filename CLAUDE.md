...
- **837 checks across 39 audit modules.** Measure, never estimate — and know which number you
  ...
  `--modules` choices. Check IDs: **483** are written as literals and **354** appear once the
  ...
  `IAM-<sod rule>` (7). The two sets do not overlap, so they add to 837.
  ...
  It covers all 837 ids — 483 literal plus 354 from six runtime families —
