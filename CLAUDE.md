...
- **829 checks across 39 audit modules.** Measure, never estimate — and know which number you
  ...
  `--modules` choices. Check IDs: **476** are written as literals and **353** appear once the
  ...
  `IAM-<sod rule>` (7). The two sets do not overlap, so they add to 829.
  ...
  It covers all 829 ids — 476 literal plus 353 from six runtime families —
