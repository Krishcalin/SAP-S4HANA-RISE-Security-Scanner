...
| `role_auth_values` | `role_auth_values.csv`, `role_authorizations.csv`, `agr1251_values.csv` | `abap_authorizations`, `access_risk_analysis`, `iam_advanced`, `role_governance` | documented |
