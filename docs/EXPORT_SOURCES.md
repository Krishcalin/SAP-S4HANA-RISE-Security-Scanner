...
| `os_file_permissions` | `os_file_permissions.csv`, `file_permissions.csv`, `usr_sap_perms.csv` | `os_security` | documented · not obtainable in RISE |
| `os_groups` | `os_groups.csv`, `group.csv`, `getent_group.csv` | `os_security` | documented · not obtainable in RISE |
| `os_services` | `os_services.csv`, `host_services.csv`, `systemctl_units.csv` | `os_security` | documented · not obtainable in RISE |
| `os_users` | `os_users.csv`, `passwd.csv`, `getent_passwd.csv` | `os_security` | documented · not obtainable in RISE |
| `parameter_transactions` | `parameter_transactions.csv`, `tstcp.csv` | `abap_authorizations` | documented |
