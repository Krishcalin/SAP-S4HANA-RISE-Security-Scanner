...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/checks-838%20in%2039%20modules-red?style=flat-square" alt="838 checks in 39 modules"/>
...
**838 checks across 39 modules.** Every one is listed, with what it reads and
...
144 different export sources, all of them files a Basis or security team can
...
119 of 144 sources" is true and useless on its own. Each scan ends with something
you can act on:
